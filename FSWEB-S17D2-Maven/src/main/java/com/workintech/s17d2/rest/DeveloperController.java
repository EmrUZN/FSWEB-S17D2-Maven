...
public class DeveloperController {
    ...
    public void init(){
        ...
        this.developers.put(1, new Developer(1, Experience.SENIOR,1000d, "emre"));
    }
    @PostMapping
    ...
    public DeveloperResponse save(@RequestBody Developer developer) {
        ...
        return new DeveloperResponse(createdDeveloper,HttpStatus.CREATED.value(), "CREATE İŞLEMİ BAŞARILI");
    }
    ...
    public DeveloperResponse delete(@PathVariable("id") int id){
        ...
        return new DeveloperResponse(removedDeveloper,HttpStatus.NO_CONTENT.value(), "SİLME BAŞARILI");
    }
}
